    ...
    <Box sx={{
      ...
      <Box sx={{
        ...
        {/* The upper `1fr`. An empty element rather than a `gridRow: 2` on the box below it,
            ...
            THE PICK'EM BUTTON SAT HERE FOR AN HOUR AND CAME OUT AGAIN. It fits, and the
            geometry held, and it was still the wrong place: at sm+ it was in the corner of a
            card that a phone reader has to open before they see any of it, and on a phone
            `order` had to send it back to the end of the stack, which put DOM order and visual
            order out of step. The top of the card is above the fold at every width and is
            visible even while the diagram is collapsed. */}
