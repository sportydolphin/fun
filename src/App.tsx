...
import { wpblViewFromPath, wpblPlayerSlugFromPath, wpblGameSlugFromPath, isWpblPlayersIndex, isWpblLeaguePage, isWpblGlossaryPage, isWpblSourcesPage, isWpblSeasonPage, isWpblScorigamiPage, isWpblPhotosPage, isWpblReadingPage, isWpblComparePage, wpblAppOwnsPath, wpblGamePath, WPBL_PATH_EVENT } from './wpbl/routes'
...
const WpblReadingPage = lazy(() => import('./wpbl/ReadingPage'))
...
const isWpblSection = (p: string) =>
  ...
  || isWpblSourcesPage(p) || isWpblSeasonPage(p) || isWpblScorigamiPage(p) || isWpblPhotosPage(p) || isWpblReadingPage(p) || isWpblPlayersIndex(p) || isWpblComparePage(p)
